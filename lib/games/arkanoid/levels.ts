// Definición de niveles de Arkanoid, portada desde
// references/started-games/04-arkanoid/levels.js.

export type BlockColor =
  "red" | "yellow" | "cyan" | "magenta" | "hotpink" | "green" | "gray";

export type BlockDef = { col: number; row: number; color: BlockColor };
export type LevelDef = { speed: number; blocks: BlockDef[] };
